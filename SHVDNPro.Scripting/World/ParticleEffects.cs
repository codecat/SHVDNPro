...
namespace GTA
{
	...
	public class ParticleEffectsAsset : INativeValue
	{
		#region Fields
		...
		{
			get { return (ulong)Function.AddStringPool(_assetName).ToInt64(); }
			set { /* unsupported */ }
		}
	}

	public abstract class ParticleEffect : INativeValue
	{
		#region Fields
