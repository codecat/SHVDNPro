	...
	public sealed class Weapon
	{
		...
		public bool IsPresent
		{
			get
			{
				...
				return Function.Call<bool>(GTA.Hash.HAS_PED_GOT_WEAPON, _owner.Handle, Hash);
			}
		}
		...
		public Model Model
		{
			get
			{
				return new Model(Function.Call<int>(GTA.Hash.GET_WEAPONTYPE_MODEL, Hash));
			}
		}
		public WeaponTint Tint
		{
			get
			{
				return Function.Call<WeaponTint>(GTA.Hash.GET_PED_WEAPON_TINT_INDEX, _owner.Handle, Hash);
			}
			set
			{
				Function.Call(GTA.Hash.SET_PED_WEAPON_TINT_INDEX, _owner.Handle, Hash, value);
			}
		}
		public WeaponGroup Group
		{
			get
			{
				return Function.Call<WeaponGroup>(GTA.Hash.GET_WEAPONTYPE_GROUP, Hash);
			}
		}
		...
		public int Ammo
		{
			get
			{
				...
				return Function.Call<int>(GTA.Hash.GET_AMMO_IN_PED_WEAPON, _owner.Handle, Hash);
			}
			set
			{
				if (Hash == WeaponHash.Unarmed)
				...
				if (IsPresent)
				{
					Function.Call(GTA.Hash.SET_PED_AMMO, _owner.Handle, Hash, value);
				}
				else
				{
					Function.Call(GTA.Hash.GIVE_WEAPON_TO_PED, _owner.Handle, Hash, value, false, true);
				}
			}
		}
		public int AmmoInClip
		{
			get
			{
				...
				Function.Call(GTA.Hash.GET_AMMO_IN_CLIP, _owner.Handle, Hash, ammoInClip);
			...
			set
			{
				...
				if (IsPresent)
				{
					Function.Call(GTA.Hash.SET_AMMO_IN_CLIP, _owner.Handle, Hash, value);
				}
				else
				{
					Function.Call(GTA.Hash.GIVE_WEAPON_TO_PED, _owner.Handle, Hash, value, true, false);
				}
			}
		}
		public int MaxAmmo
		{
			get
			{
				...
				Function.Call(GTA.Hash.GET_MAX_AMMO, _owner.Handle, Hash, maxAmmo);
		...
		public int MaxAmmoInClip
		{
			get
			{
				...
				return Function.Call<int>(GTA.Hash.GET_MAX_AMMO_IN_CLIP, _owner.Handle, Hash, true);
			}
		}
		public int DefaultClipSize
		{
			get
			{
				return Function.Call<int>(GTA.Hash.GET_WEAPON_CLIP_SIZE, Hash);
			}
		}
		public bool InfiniteAmmo
		{
			set
			{
				...
				Function.Call(GTA.Hash.SET_PED_INFINITE_AMMO, _owner.Handle, value, Hash);
			}
		}
		public bool InfiniteAmmoClip
		{
			set
			{
				Function.Call(GTA.Hash.SET_PED_INFINITE_AMMO_CLIP, _owner.Handle, value);
			}
		}
		...
		public bool CanUseOnParachute
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.CAN_USE_WEAPON_ON_PARACHUTE, Hash);
			}
		}
		...
		public void SetComponent(WeaponComponent component, bool active)
		{
			if (active)
			{
				Function.Call(GTA.Hash.GIVE_WEAPON_COMPONENT_TO_PED, _owner.Handle, Hash, component);
			}
			else
			{
				Function.Call(GTA.Hash.REMOVE_WEAPON_COMPONENT_FROM_PED, _owner.Handle, Hash, component);
			}
		}
		public bool IsComponentActive(WeaponComponent component)
		{
			return Function.Call<bool>(GTA.Hash.HAS_PED_GOT_WEAPON_COMPONENT, _owner.Handle, Hash, component);
		}
		...
		public static string GetDisplayNameFromHash(WeaponHash hash)
		{
			...
			for (int i = 0, count = Function.Call<int>(GTA.Hash.GET_NUM_DLC_WEAPONS); i < count; i++)
			{
				if (Function.Call<bool>(GTA.Hash.GET_DLC_WEAPON_DATA, i, data))
				{
		...
		public static WeaponComponent[] GetComponentsFromHash(WeaponHash hash)
		{
			...
			for (int i = 0, count = Function.Call<int>(GTA.Hash.GET_NUM_DLC_WEAPONS); i < count; i++)
			{
				if (Function.Call<bool>(GTA.Hash.GET_DLC_WEAPON_DATA, i, data))
				{
					if (MemoryAccess.ReadInt(data + 8) == (int)hash)
					{
						result = new WeaponComponent[Function.Call<int>(GTA.Hash.GET_NUM_DLC_WEAPON_COMPONENTS, i)];

						for (int j = 0; j < result.Length; j++)
						{
							if (Function.Call<bool>(GTA.Hash.GET_DLC_WEAPON_COMPONENT_DATA, i, j, data))
							{
		...
		public static string GetComponentDisplayNameFromHash(WeaponHash hash, WeaponComponent component)
		{
			...
			for (int i = 0, count = Function.Call<int>(GTA.Hash.GET_NUM_DLC_WEAPONS); i < count; i++)
			{
				if (Function.Call<bool>(GTA.Hash.GET_DLC_WEAPON_DATA, i, data))
				{
					if (MemoryAccess.ReadInt(data + 8) == (int)hash)
					{
						int maxComp = Function.Call<int>(GTA.Hash.GET_NUM_DLC_WEAPON_COMPONENTS, i);
