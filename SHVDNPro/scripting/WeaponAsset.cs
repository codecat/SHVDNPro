...
namespace GTA
{
	public struct WeaponAsset : IEquatable<WeaponAsset>, INativeValue
	{
		...
		public bool IsValid
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.IS_WEAPON_VALID, Hash);
			}
		}
		public bool IsLoaded
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.HAS_WEAPON_ASSET_LOADED, Hash);
			}
		}

		public void Request()
		{
			Function.Call(GTA.Hash.REQUEST_WEAPON_ASSET, Hash, 31, 0);
		}
		...
		public void Dismiss()
		{
			Function.Call(GTA.Hash.REMOVE_WEAPON_ASSET, Hash);
		}
