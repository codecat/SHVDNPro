...
namespace GTA
{
	public struct Model : IEquatable<Model>, INativeValue
	{
		...
		public bool IsValid
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.IS_MODEL_VALID, Hash);
			}
		}
		public bool IsInCdImage
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.IS_MODEL_IN_CDIMAGE, Hash);
			}
		}
		public bool IsLoaded
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.HAS_MODEL_LOADED, Hash);
			}
		}
		public bool IsCollisionLoaded
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.HAS_COLLISION_FOR_MODEL_LOADED, Hash);
			}
		}
		...
		public bool IsBicycle
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.IS_THIS_MODEL_A_BICYCLE, Hash);
			}
		}
		public bool IsBike
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.IS_THIS_MODEL_A_BIKE, Hash);
			}
		}
		public bool IsBoat
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.IS_THIS_MODEL_A_BOAT, Hash);
			}
		}
		public bool IsCar
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.IS_THIS_MODEL_A_CAR, Hash);
			}
		}
		...
		public bool IsHelicopter
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.IS_THIS_MODEL_A_HELI, Hash);
			}
		}
		public bool IsPed
		{
		...
		public bool IsPlane
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.IS_THIS_MODEL_A_PLANE, Hash);
			}
		}
		public bool IsProp
		{
		...
		public bool IsQuadbike
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.IS_THIS_MODEL_A_QUADBIKE, Hash);
			}
		}
		public bool IsTrain
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.IS_THIS_MODEL_A_TRAIN, Hash);
			}
		}
		public bool IsVehicle
		{
			get
			{
				return Function.Call<bool>(GTA.Hash.IS_MODEL_A_VEHICLE, Hash);
			}
		}
		...
		public void GetDimensions(out Vector3 minimum, out Vector3 maximum)
		{
			...
			Function.Call(GTA.Hash.GET_MODEL_DIMENSIONS, Hash, minimumArg, maximumArg);
		...
		public void Request()
		{
			Function.Call(GTA.Hash.REQUEST_MODEL, Hash);
		}
		...
		{
			Function.Call(GTA.Hash.SET_MODEL_AS_NO_LONGER_NEEDED, Hash);
		}
